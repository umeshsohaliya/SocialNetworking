...
import com.rta.generic.poll_generic;


public class playpoll extends ActionSupport {
	List<poll_generic> list =null;
	 ...
	 * @return the list
	 */
	public List<poll_generic> getList() {
		return list;
	}
	 ...
	 */
	public void setList(List<poll_generic> list) {
		this.list = list;
	}
int poll_id;
int pid ;
...
public void setPoll_id(int poll_id) {
	...
	public String execute()throws Exception{
		System.out.println("ply poll.java");
		try{
